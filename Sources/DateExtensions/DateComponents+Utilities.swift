//
//  DateComponents+Utilities.swift
//  DateExtensions
//
...
public extension Date {
	...
	static let commonComponents: Set<Calendar.Component> = [.year, .month, .day, .hour, .minute, .second]
	...
	static let dateComponents: Set<Calendar.Component> = [.year, .month, .day]
    
    /// Returns set of HMS
	static let timeComponents: Set<Calendar.Component> = [.hour, .minute, .second, ]
    
    /// Returns set of MDYHMS components
	static let dateAndTimeComponents: Set<Calendar.Component> = [.hour, .minute, .second, .year, .month, .day]
}
...
extension DateComponents {
    ...
    /// let units: [DateComponentsFormatter.DateExtensions.UnitsStyle] = [.positional, .abbreviated, .short, .full, .spellOut]
